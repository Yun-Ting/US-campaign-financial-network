...
```{r}
library(igraph)
nodes <- read.csv("/Users/yunting/Desktop/5_election_year_results/year2008/nodes.csv", header=T, as.is=T)
links <- read.csv("/Users/yunting/Desktop/5_election_year_results/year2008/edges.csv", header=T, as.is=T)
